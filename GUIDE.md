...
1. **两色交错 = 第九种颜色，这是这块画布最大的富矿。** 天该有深浅（天顶掺深色、
   地平线掺亮色）、光该有方向（受光面掺暖色、背光面掺冷色）、水该有反光——
   大色块的交界处用 `dither` 羽化两三个像素，让颜色互相渗透，八色能读出二十色。
   通体匀色的大色块 = 贴纸。
2. **明暗分三层。** 眯眼看草稿：亮、中、暗至少三层、界线清楚。混色是为了加富层次，
   不是取消层次——糊成一团中灰，就是混过了头。
